...
from app.services.introspector import (
 get_table_schema, get_database_schema
)
...
@router.post("/schema", response_model=DatabaseSchemaResponse)
...
@router.post("/introspect/table", response_model=TableSchemaResponse)
async def introspect_table_schema(request: TableSchemaRequest):

...
class DatabaseSeeder:
    ...
    def seed(
        ...
        try:
            ...
            for record in data:
                ...
                flat_record = self._flatten_dict_for_db(record)
            ...
            if not processed_data:
                ...
                return {
                    "success": False,
                    "records_inserted": 0,
                    "error": "No valid data to insert after filtering"
                }
            ...
            return {
                ...
                "table": table,
                "batches_processed": len(range(0, len(processed_data), batch_size))
            }
    ...
    def _flatten_dict_for_db(self, d: Dict[str, Any], parent_key: str = '', sep: str = '_') -> Dict[str, Any]:
        ...
        for k, v in d.items():
            ...
            if isinstance(v, dict):
                ...
                items.extend(self._flatten_dict_for_db(v, new_key, sep=sep).items())
